...
☆ Kedapkedip ( Teks kekinian 􀜁􀅔Har Har􏿿 , Contoh : Kedapkedip irulz )
☆ /apakah ( Kerang ajaib #
...
#--------------------------------- ABSEN ------------------------------------
                ...
                cl.sendText(msg.to,"Hadir 􀜁􀅹Salute􏿿")
                ki.sendText(msg.to,"Hadir  􀜁􀅹Salute􏿿")
                kk.sendText(msg.to,"Hadir 􀜁􀅹Salute􏿿")
                kc.sendText(msg.to,"Hadir 􀜁􀅹Salute􏿿")
#----------------------------------------------------------------------------
#------------------------------ RESPON SPEED --------------------------------
